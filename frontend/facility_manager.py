...
class FacilityManagerInterface(tk.Tk):
    ...
    def create_widgets(self):
        ...
        self.logged_in_label = ttk.Label(self.header_frame, text=f"Logged in as Facility Manager: {self.first_name} {self.last_name}", font=('Arial', 12), style='Header.TLabel')
